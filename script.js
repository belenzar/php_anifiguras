...
let weather = {
  ...
  fetchWeather: function (city) {
    ...
    if(cantBusq==0) {
        ...
        localStorage.setItem("data",JSON.stringify({"coord":{"lon":-58.3772,"lat":-34.6132},"weather":[{"id":802,"main":"Clouds","description":"scattered clouds","icon":"03n"}],"base":"stations","main":{"temp":16.31,"feels_like":16.5,"temp_min":14.9,"temp_max":16.85,"pressure":1009,"humidity":96},"visibility":10000,"wind":{"speed":5.66,"deg":80},"clouds":{"all":40},"dt":1633040874,"sys":{"type":1,"id":8224,"country":"AR","sunrise":1632994271,"sunset":1633038931},"timezone":-10800,"id":3435910,"name":"Buenos Aires","cod":200}));
    }
